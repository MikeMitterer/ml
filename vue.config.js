...
// http://bit.ly/2P5Pzdu
module.exports = {
    // Kommt von da: https://github.com/vuejs/vue-cli/issues/1462#issuecomment-526557485
    // Ist das Setting nicht vorhanden kommt die Fehlermeldung
    //          No PostCSS Config found with...
    css: {
        loaderOptions: {
            postcss: {
                plugins: [
